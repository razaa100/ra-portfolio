            ...
            <section id="about" className="py-24">
                <div className="max-w-5xl mx-auto px-4 space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center gap-10">
                        ...
                        <p className="max-w-xl text-gray-300 leading-relaxed">
                            I enjoy <span className="text-yellow-400">understanding</span> the things that I am curious about. That includes you.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-10">
                        ...
                        <p className="max-w-xl text-gray-300 leading-relaxed">
                            I don't take life seriously, (I don't think you should too). I am <span className="text-gray-500">bored</span> out of my mind most of the time but that's what drives my curiosity. I also don't enjoy living in the daily grind. I think there's much more to life than working, so I focus on experiences, ideas, and things that actually matter.<br /><br />
                        </p>
                    </div>
                </div>
            </section>
