                ...
                <div className="max-w-5xl mx-auto px-4 space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-10">
                        ...
                        <p className="max-w-xl text-gray-300 leading-relaxed">
                            ...
                            work. Over time, I discovered a passion for coding and problem-solving
                            that drives everything I do today.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center gap-10">
                        ...
                        <p className="max-w-xl text-gray-300 leading-relaxed">
                            ...
                            enjoy working with teams that push creative and technical boundaries.
                        </p>
                    </div>
